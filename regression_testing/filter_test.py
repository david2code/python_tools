...
class Resquest(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        server_side_req_body = self.rfile.read(
...
def send_post():
    ...
    body = b"11122233344455566778899"
...
def old_envoy_process():
    ...
    os.execl(
        "envoy",
        "envoy",
        "-c plugin-loader.yaml",
        "--component-log-level main:error,http:error,conn_handler:error,plugin:error",
        "--concurrency 2",
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-6", "--ipv6", action="store_true", dest="ipv6", help="run on ipv6"
    )
    ...
    for test_mode in range(0, 21):
        ...
        if test_mode == 0:
            ...
            assert server_side_req_header["Header-To-Add"] == "plugin add header", (
                "test failed"
            )
            assert (
                server_side_req_header["Header-To-Modify"]
                == "1234567_plugin_modified_onDecodeHeader_Continue"
            ), "test failed"
            ...
            assert (
                resp_headers["Header-To-Modify"]
                == "1234567_plugin_modified_onEncodeHeader_Continue"
            ), "test failed"
        ...
        # onDecodeHeader Break
            ...
            assert (
                server_side_req_header["Header-To-Modify"]
                == "1234567_plugin_modified_onDecodeHeader_Break"
            ), "test failed"
            assert server_side_req_header.get("Header-To-Remove") == None, "test_faled"
        # onDecodeHeader Pause then continue
            ...
            assert (
                server_side_req_header["Header-To-Modify"]
                == "1234567_plugin_modified_onDecodeHeader_Pause_then_Continue"
            ), "test failed"
            assert server_side_req_header.get("Header-To-Remove") == None, "test_faled"
        ...
        # onDecodeData WaitForBody
            ...
            assert resp_status_code == 200, "test failed"
            assert (
                server_side_req_body == "request body modify onDecodeData wait for body"
            ), "test failed"
        # onDecodeData tryWaitForBody
        elif test_mode == 6:
            assert resp_status_code == 200, "test failed"
            assert (
                server_side_req_body
                == "request body modify onDecodeData try wait for body"
            ), "test failed"
        ...
        # onDecodeData Pause then continue
            ...
            assert (
                server_side_req_header["Header-To-Modify"]
                == "1234567_plugin_modified_onDecodeData_Pause_then_Continue"
            ), "test failed"
            assert server_side_req_header.get("Header-To-Remove") == None, "test_faled"
        # onDecodeData Pause then DirectResponse
            ...
            assert (
                server_side_req_body
                == "request body modify onDecodeData pause then modify body"
            ), "test failed"
        elif test_mode == 10:
            assert resp_status_code == 403, "test failed"
            assert resp_body == "DirectResponse onDecodeData", "test failed"
        ...
        # onEncodeHeader Break
            ...
            assert (
                resp_headers["Header-To-Modify"]
                == "1234567_plugin_modified_onEncodeHeader_Break"
            ), "test failed"
            assert resp_headers.get("Header-To-Remove") == None, "test_faled"
        # onEncodeHeader Pause then continue
            ...
            assert (
                resp_headers["Header-To-Modify"]
                == "1234567_plugin_modified_onEncodeHeader_Pause_then_Continue"
            ), "test failed"
            assert resp_headers.get("Header-To-Remove") == None, "test_faled"
        ...
        # onEncodeData WaitForBody
            ...
            assert resp_status_code == 200, "test failed"
            assert resp_body == "response body modify onEncodeData wait for body", (
                "test failed"
            )
        # onEncodeData tryWaitForBody
        elif test_mode == 16:
            assert resp_status_code == 200, "test failed"
            assert resp_body == "response body modify onEncodeData try wait for body", (
                "test failed"
            )
        ...
        # onEncodeData Pause then continue
            ...
            assert (
                resp_headers["Header-To-Modify"]
                == "1234567_plugin_modified_onEncodeData_Pause_then_Continue"
            ), "test failed"
            assert resp_headers.get("Header-To-Remove") == None, "test_faled"
        elif test_mode == 19:
            # check header modify
            assert resp_status_code == 200, "test failed"
            assert (
                resp_body == "response body modify onEncodeData pause then modify body"
            ), "test failed"
